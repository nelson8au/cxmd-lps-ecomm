    ...
    Pagination.prototype = {
        ...
        bindEvent: function(){
            ...
            function creatBtns(ismorePosition){
                ...
                var prevbtn = '<span class="pagination-btn iconfont" id="pagination-prev">&#xe674;</span>';
                var nextbtn = '<span class="pagination-btn iconfont" id="pagination-next">&#xe674;</span>'
                if(this._currentPage == 1){
                    firstbtn = '<li class="pagenum pagination-btn pagination-current" data-num="1">1</li>';
                    prevbtn = '<span class="pagination-btn pagination-disabled iconfont" id="pagination-prev">&#xe674;</span>'
                }
                if(this._currentPage == this._btnNum){
                    ...
                    nextbtn = '<span class="pagination-btn pagination-disabled iconfont" id="pagination-next">&#xe674;</span>'
                }
