;(function($, window, undefined) {
    ...
    let ajax_post = function(){
        ...
        $(document).on('click', '.ajax-post', function (e) {
            ...
            if(target_form){
                ...
                if(query ==''){
                    toast.error('Please select the target to operate on!','danger');
                    return false;
                }
            }
            ...
            if($(this).attr('data-confirm') || $(this).hasClass('confirm')){
                var confirmText = $(this).attr('data-confirm');
                    confirmText = confirmText ? confirmText : "Are you sure you want to proceed with this operation?";
            }
    ...
    var handle_ajax = function(data) {
        ...
        if (data.url) {
            data.msg += ', The page will redirect shortly~';
        }
     ...
     */
    var modal_confirm = function(confirmText,callback) {

        if(confirmText == ''){
            confirmText = 'Are you sure you want to proceed with this operation?';
        }
        
        // 自定义模态框样式
        let custom = '<div class="text-center">'+
                        '<i class="fa fa-exclamation-circle"></i>'+
                        '<p class="title">System Message</p>'+
                        '<p class="desc">'+ confirmText +'</p>'+
                        '<div class="text-center">'+
                            '<button class="btn btn-info confirm margin-right" type="button">Confirm</button>'+
